...
def translate(instr):
	...
	if oprtr in GV.mathops:				# Assembly code for TAC being math op
	...
	elif oprtr == "&&":					# Assembly code for TAC being logical AND op (LINENO, &&, RESULT, OPRND1, OPRND2)
		oprtn_rslt = instr[2]
		oprnd1 = instr[3]
		oprnd2 = instr[4]
		if RAF.isNum(oprnd1) and RAF.isNum(oprnd2):
	...
	elif oprtr == "||":					# Assembly code for TAC being logical OR op (LINENO, ||, RESULT, OPRND1, OPRND2)
		oprtn_rslt = instr[2]
		oprnd1 = instr[3]
		oprnd2 = instr[4]
		if RAF.isNum(oprnd1) and RAF.isNum(oprnd2):
		...
		if oprtr == "<=":
			...
			GV.assembly = GV.assembly + "jl " + label + "\n"
		elif oprtr == ">":
			GV.assembly = GV.assembly + "jg " + label + "\n"
		elif oprtr == "!=":
